...
class Template_header_m extends CI_Model
{
	...
	function __construct()
        ...
        public function nav()
        {
            $data['category'] = $this->nav_m->get_categories();
            return $this->load->view('header/nav', $data, TRUE);
        }
		...
		{
			$data = '';
			return $this->load->view('header/logo',$data,TRUE);
		}
