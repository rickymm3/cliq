...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Cliq!';
$config['webmaster_email'] = 'admin@rickymason.net';
...
$config['recaptcha_public_key'] = '6LeA6N4SAAAAANACntf91nlhzqTOoXvK_HjYfSuV';
$config['recaptcha_private_key'] = '6LeA6N4SAAAAANrpe2YHweuCZImq6AWx-0OtR_8P';
